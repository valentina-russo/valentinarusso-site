 ...
 * Access: https://valentinarussobg5.com/corso/reset-admin.php?token=corso_reset_2026_k7m2x9
 */

header('Content-Type: application/json; charset=utf-8');

$token = $_GET['token'] ?? '';
if (!hash_equals('corso_reset_2026_k7m2x9', $token)) {
...
try {
    ...
    // session_ver++ invalida qualunque sessione vecchia rimasta attiva altrove
    ...
    if ($stmt->rowCount() === 0) {
        ...
        $log[] = 'PASSWORD (mostrata solo ora, salvala subito): ' . $newPassword;
    }
