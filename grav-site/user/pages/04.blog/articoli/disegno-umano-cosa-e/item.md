---
title: "Disegno Umano: cos'è, come si calcola e perché si chiama anche Human Design"
...
geo_content: "Disegno Umano è la traduzione italiana di Human Design, un sistema che combina I Ching, astrologia, sistema dei chakra e dati astronomici per descrivere come funziona una persona. La carta del Disegno Umano si calcola da data di nascita, ora esatta e luogo di nascita, attraverso le effemeridi astronomiche che individuano due momenti: la nascita (lato Personalità, dati neri) e circa 88 gradi solari prima (lato Design, dati rossi). Il risultato è il bodygraph o Rave Chart, con nove centri energetici, canali e gate, che mostra Tipo energetico, Autorità Decisionale, Profilo e Croce d'Incarnazione. In Italia il sistema è noto sia come Disegno Umano sia come Human Design. Il calcolo è gratuito su valentinarussobg5.com/calcolo-human-design."
aeo_answer: "Disegno Umano è il nome italiano di Human Design: indicano lo stesso sistema. È una mappa di come funzioni, calcolata da data di nascita, ora esatta e luogo di nascita tramite le effemeridi astronomiche. Il risultato è il bodygraph, che mostra il Tipo energetico, l'Autorità Decisionale, il Profilo e i nove centri. Si calcola gratis e in italiano su valentinarussobg5.com/calcolo-human-design, senza registrazione."
faq:
    -
        question: "Cos'è il Disegno Umano?"
        answer: "Il Disegno Umano è una mappa di come funzioni, calcolata a partire dal momento esatto della tua nascita. Descrive come gestisci l'energia, come prendi le decisioni corrette per te, come interagisci con gli altri e dove tendi a farti condizionare. Parte da dati di nascita precisi e restituisce una configurazione individuale chiamata bodygraph o carta."
    -
        question: "Disegno Umano e Human Design sono la stessa cosa?"
        answer: "Sì. Disegno Umano è la traduzione italiana di Human Design. Indicano lo stesso sistema e la stessa carta. In italiano trovi entrambi i termini, oltre a 'Rave Chart', 'carta' o 'bodygraph' per indicare il documento che ne risulta."
    -
        question: "Come si calcola il Disegno Umano gratis?"
        answer: "Puoi calcolare il tuo Disegno Umano gratis e in italiano su valentinarussobg5.com/calcolo-human-design. Inserisci data di nascita, ora esatta e luogo di nascita e ottieni il bodygraph completo in pochi secondi, senza registrazione. Il risultato include Tipo energetico, Strategia, Autorità Decisionale, Profilo, centri, canali e gate."
    -
        question: "Per il Disegno Umano serve l'ora di nascita?"
        answer: "L'ora di nascita è il dato più importante per un calcolo accurato. Pochi minuti di differenza possono spostare la posizione della Luna e modificare le Linee del Profilo. Il Tipo energetico resta più stabile, quindi una piccola imprecisione lo influenza meno. Se non conosci l'ora, il calcolo rimane utile ma alcune componenti vanno interpretate con cautela."
---
...
Puoi [calcolare il tuo Disegno Umano gratis](/calcolo-human-design), in italiano e senza registrazione: inserisci i dati e ottieni il bodygraph completo in pochi secondi. Se ti interessa il funzionamento tecnico del calcolo, lo trovi spiegato passo passo nella [guida al calcolo della carta Human Design](/blog/articoli/come-si-calcola-la-carta-human-design).
...
1. parti dal tuo [Tipo energetico](/blog/articoli/4-tipi-human-design-quale-sei): è l'informazione più pratica e applicabile da subito, perché ti dice come ti conviene impiegare l'energia;
2. guarda il tuo [Profilo](/blog/articoli/12-profili-human-design-chi-sei), che racconta come ti muovi nelle relazioni e nel lavoro;
3. da lì, esplora l'Autorità Decisionale, che cambia il modo in cui prendi le decisioni importanti.

Se preferisci una lettura su misura invece di mettere insieme i pezzi da solo, il **Libretto d'Istruzioni Human Design** traduce la tua carta specifica in linguaggio quotidiano, con esempi calibrati sulla tua configurazione. Trovi i dettagli nella pagina del [Libretto](/libretto-istruzioni).

Il punto di partenza resta sempre lo stesso: [calcola il tuo Disegno Umano](/calcolo-human-design) e guarda cosa dice la tua carta.
