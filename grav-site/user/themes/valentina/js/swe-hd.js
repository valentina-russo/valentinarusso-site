// Browser shims for CommonJS compatibility
...
var _SwissEphemeris = class _SwissEphemeris {
  ...
  async init(wasmPath) {
    ...
    if (!resolvedWasmPath) {
      try {
        resolvedWasmPath = new URL("./swisseph.wasm", '/user/themes/valentina/js/swisseph-browser.js').href;
      } catch (e) {
   ...
   */
  dateToJulianDay(date, calendarType = (void 0).Gregorian) {
    this._checkReady();
...
// ESM exports removed for browser <script> compatibility
